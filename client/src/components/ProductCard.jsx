...
const ProductCard = ({product}) => {
    ...
    return product && (
        ...
        className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-80 max-w-80 w-full">
                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e)=>{e.stopPropagation()}} className="text-primary">
                        {!cartItems[product._id] ? (
                            ...
                            w-[64px] h-[34px] rounded cursor-pointer  font-medium" onClick={() => addToCart(product._id)} >
                                <img src={assets.cart_icon} alt="add to cart" className="md:w-4 w-3" />
                                Add
                            </button>
                        ) : (
